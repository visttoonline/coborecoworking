            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a href={`https://wa.me/${WHATSAPP}?text=${encodeURIComponent('Olá! Vim pelo site do COBORE e gostaria de mais informações.')}`}
              ...
              <div className="w-full h-48 border border-cobore-border overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3459.785!2d-52.34276!3d-31.76538!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9511a0c5e1b4a8f1%3A0x5b0b2b2b2b2b2b2b!2sR.+Bar%C3%A3o+de+Santa+Tecla%2C+466+-+Centro%2C+Pelotas+-+RS%2C+96010-140!5e0!3m2!1spt-BR!2sbr!4v1"
                  width="100%"
                  height="100%"
                  style={{border: 0}}
                  allowFullScreen
              ...
              {enviado ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <textarea id="mensagem" rows={4} required placeholder="Como podemos ajudar?"
